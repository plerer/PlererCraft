...
public class ModelBiped extends ModelBase
{
    ...
    public ModelBiped(float f, float f1)
    {
        ...
        HatBrim = new ModelRenderer(this, 0, 21);
        HatBrim.addBox(-5F, -8F, -5F, 10, 1, 10);
        HatBrim.setRotationPoint(0.0F, 0.0F + f1, 0.0F);
        HatTop = new ModelRenderer(this, 0, 0);
        HatTop.addBox(-4F, -16F, -4F, 8, 6, 8);
        HatTop.setRotationPoint(0.0F, 0.0F + f1, 0.0F);
    ...
    {
        HatBrim.rotateAngleY = bipedHead.rotateAngleY;
        HatBrim.rotateAngleX = bipedHead.rotateAngleX;
